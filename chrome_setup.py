...
def setup_chrome_driver():
    ...
    try:
        ...
        # Railway-specific settings untuk mencegah crash
        ...
        # Memory management untuk mencegah crash
        ...
        # Experimental flags untuk stability
        ...
        # Set timeouts yang lebih aman
        driver.set_page_load_timeout(60)
        driver.set_script_timeout(30)
        driver.implicitly_wait(10)
        
        # Set window size untuk konsistensi
